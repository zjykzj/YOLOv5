...
from yolo.model.yolov5 import SegmentationModel
from yolo.model.impl.autoanchor import check_anchors
from yolo.model.impl.modelema import ModelEMA
from yolo.engine.autobatch import check_train_batch_size
from yolo.engine.callbacks import Callbacks
from yolo.engine.earlystop import EarlyStopping
from yolo.engine.resume import smart_resume
from yolo.optim.build import strip_optimizer, smart_optimizer
from yolo.optim.onecycle import one_cycle
from yolo.data.auxiliary import check_dataset

from yolo import TQDM_BAR_FORMAT
from yolo.utils.logger import LOGGER
from yolo.utils.loggers import GenericLogger
from yolo.utils.downloads import attempt_download, is_url
from yolo.utils.fileutil import check_file, get_latest_run, increment_path, yaml_save, check_yaml, check_suffix
from yolo.utils.gitutil import check_git_status, check_git_info
from yolo.utils.general import check_requirements, init_seeds, labels_to_class_weights, labels_to_image_weights, \
    check_amp, check_img_size
from yolo.utils.misc import colorstr, print_args, intersect_dicts
from yolo.utils.plots import plot_labels
from yolo.utils.ddputil import de_parallel, smart_DDP
from yolo.utils.torchutil import select_device, torch_distributed_zero_first

from yolo.utils.segment.dataloaders import create_dataloader
from yolo.utils.segment.loss import ComputeLoss
from yolo.utils.segment.metrics import KEYS, fitness
from yolo.utils.segment.plots import plot_images_and_masks, plot_results_with_masks
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'configs' / 'data/coco128-seg.yaml',
